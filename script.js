...
const projects = [
    ...
    },
    {
        ...
        details: 'Extends ComfyUI with 9 powerful custom nodes:<br><br><strong>Nodes:</strong><br>• <a href="https://github.com/basiphobe/basify/blob/main/py/docs/DIRECTORY_AUTO_ITERATOR_README.md" target="_blank" rel="noopener noreferrer">Directory Auto Iterator</a><br>• <a href="https://github.com/basiphobe/basify/blob/main/py/docs/DIRECTORY_CHECKPOINT_SCANNER_README.md" target="_blank" rel="noopener noreferrer">Directory Checkpoint Scanner</a><br>• <a href="https://github.com/basiphobe/basify/blob/main/py/docs/LLM_DESCRIBE_README.md" target="_blank" rel="noopener noreferrer">Describe Image (LLM)</a><br>• <a href="https://github.com/basiphobe/basify/blob/main/py/docs/LATENT_GENERATOR_README.md" target="_blank" rel="noopener noreferrer">Latent Generator</a><br>• <a href="https://github.com/basiphobe/basify/blob/main/py/docs/WILDCARD_PROCESSOR_README.md" target="_blank" rel="noopener noreferrer">Wildcard Processor</a><br>• <a href="https://github.com/basiphobe/basify/blob/main/py/docs/METADATA_VIEWER_README.md" target="_blank" rel="noopener noreferrer">Metadata Viewer</a><br>• <a href="https://github.com/basiphobe/basify/blob/main/py/docs/DISPLAY_ANYTHING_README.md" target="_blank" rel="noopener noreferrer">Display Anything as Text</a><br>• <a href="https://github.com/basiphobe/basify/blob/main/py/docs/SAVE_IMAGE_README.md" target="_blank" rel="noopener noreferrer">Save Image (Enhanced)</a><br>• <a href="https://github.com/basiphobe/basify/blob/main/py/docs/SOUND_NOTIFIER_README.md" target="_blank" rel="noopener noreferrer">Sound Notifier</a><br><br><strong>Features:</strong> Batch processing • LLM-powered image description via Ollama • Intelligent checkpoint scanning with symbolic link support • Wildcard-based text variation • Universal debugging and inspection • Enhanced image saving with metadata embedding',
